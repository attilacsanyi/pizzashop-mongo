...
import hu.attila.csanyi.mongo.pizza.web.PizzaController;
...
privileged aspect PizzaController_Roo_Controller {
    ...
    public String PizzaController.show(@PathVariable("id") BigInteger id, Model uiModel) {
    ...
    public String PizzaController.updateForm(@PathVariable("id") BigInteger id, Model uiModel) {
        populateEditForm(uiModel, pizzaService.findPizza(id));
        return "pizzas/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String PizzaController.delete(@PathVariable("id") BigInteger id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
