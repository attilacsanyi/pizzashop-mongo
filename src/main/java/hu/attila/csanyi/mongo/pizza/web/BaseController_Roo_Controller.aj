...
import hu.attila.csanyi.mongo.pizza.web.BaseController;
...
privileged aspect BaseController_Roo_Controller {
    ...
    public String BaseController.show(@PathVariable("id") BigInteger id, Model uiModel) {
    ...
    public String BaseController.updateForm(@PathVariable("id") BigInteger id, Model uiModel) {
        populateEditForm(uiModel, baseService.findBase(id));
        return "bases/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String BaseController.delete(@PathVariable("id") BigInteger id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
