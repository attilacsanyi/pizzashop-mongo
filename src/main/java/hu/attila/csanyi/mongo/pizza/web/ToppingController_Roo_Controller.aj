...
import hu.attila.csanyi.mongo.pizza.web.ToppingController;
...
privileged aspect ToppingController_Roo_Controller {
    ...
    public String ToppingController.show(@PathVariable("id") BigInteger id, Model uiModel) {
    ...
    public String ToppingController.updateForm(@PathVariable("id") BigInteger id, Model uiModel) {
        populateEditForm(uiModel, toppingService.findTopping(id));
        return "toppings/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String ToppingController.delete(@PathVariable("id") BigInteger id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
